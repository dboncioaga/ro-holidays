...
/**
 * Holiday rule for Pentecost (Rusalii/Pogorârea Sfântului Duh).
 * <p>
 * Pentecost falls 49 days after Orthodox Easter Sunday.
 * </p>
 * <p>
 * This class is immutable and thread-safe.
 * </p>
 */
public final class PentecostSundayRule implements HolidayRule {

    @Override
    public Set<Holiday> holidaysFor(int year) {
        LocalDate easterDate = OrthodoxEasterCalculator.calculateEaster(year);
        LocalDate pentecost = easterDate.plusDays(49);
        Holiday holiday = new Holiday(pentecost, "Rusalii", HolidayType.LEGAL);
