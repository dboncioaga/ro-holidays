...
/**
 * Holiday rule for Orthodox Easter Monday (A doua zi de Paște).
 * <p>
 * Easter Monday falls 1 day after Orthodox Easter Sunday.
 * </p>
 * <p>
 * This class is immutable and thread-safe.
 * </p>
 */
public final class EasterMondayRule implements HolidayRule {
    ...
    public Set<Holiday> holidaysFor(int year) {
        ...
        Holiday holiday = new Holiday(easterMonday, "A doua zi de Paște", HolidayType.LEGAL);
