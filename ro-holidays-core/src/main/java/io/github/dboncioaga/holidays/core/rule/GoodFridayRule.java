...
/**
 * Holiday rule for Orthodox Good Friday (Vinerea Mare).
 * <p>
 * Good Friday falls 2 days before Orthodox Easter Sunday.
 * </p>
 * <p>
 * This class is immutable and thread-safe.
 * </p>
 */
public final class GoodFridayRule implements HolidayRule {
    ...
    public Set<Holiday> holidaysFor(int year) {
        ...
        Holiday holiday = new Holiday(goodFriday, "Vinerea Mare", HolidayType.LEGAL);
